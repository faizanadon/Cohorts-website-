...
// All data is now driven from siteConfig.js
// ============================================================
import {
  brand,
  pricing,
...
const GlobalStyles = () => (
  <style>{`
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .nav-dropdown{display:none;position:absolute;top:calc(100% + 8px);left:0;min-width:220px;z-index:200}
...
const HomePage = ({ dark, setPage }) => {
  ...
  return (
    <div style={{ background: bg, color: text }}>
      ...
      {/* HOW THE OS WORKS — step flow (was missing) */}
...
export default function App() {
  ...
  const renderPage = () => {
    ...
    if (page.startsWith("seo-")) {
      ...
      // locationId may contain hyphens (costa-rica), so split carefully
    ...
    switch (page) {
      ...
      case "resources":
      case "blog":          return <ResourcesPage dark={dark} setPage={setPage} />;
      ...
      default:
        return (
          <div style={{ minHeight: "60vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16, padding: "0 24px", textAlign: "center" }}>
            ...
            <H2 style={{ color: dark ? "#fff" : "#0a0a0a" }}>Page not found</H2>
            <Body size={15} style={{ color: dark ? "rgba(255,255,255,0.5)" : "rgba(0,0,0,0.45)" }}>The page <code style={{ background: "rgba(79,70,229,0.1)", padding: "2px 8px", borderRadius: 5, fontSize: 13 }}>{page}</code> doesn't exist.</Body>
